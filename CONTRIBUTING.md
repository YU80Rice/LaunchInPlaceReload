...
本项目延续 [UMM 主仓库](https://github.com/YU80Rice/UnturnedModManager) 的 **Vibecoding 人机协同开发范式**：

- **人类导演**：YU80Rice（项目主理人，负责需求、设计、决策与验收）
- **AI 导师**：Claude / Kimi（架构师 + 代码执行者，由 Anthropic / Moonshot 提供）
- **本地 Agent**：Cherry Claw（基于 Cherry Studio 的本地执行终端）
- **算力后盾**：SiliconFlow / Volcengine Ark（大模型托管平台）

**所有代码均由人类主导设计意图，AI 辅助实现细节。开源协议为 MIT。**

> Vibecoding 不是"AI 写代码人类审"，而是"人类做导演，AI 做执行"——人类负责 Why，AI 负责 How。
